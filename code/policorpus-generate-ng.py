"""
    Generate N-Grams embeddings from the policorpus
...
def main ():
    ...
    # var parser
    parser = DefaultParser (description = 'Generate N-Grams (NG) features')
    ...
    # Get a custom vectorizer
    ng_transformers.load_vectorizer_from_disk (policorpus_dataset.get_working_dir (args.task, 'ng_vectorizer.pickle'))
    
    
    # @var tokenizer Tokenizer
    tokenizer = ng_transformers.get_vectorizer ()
