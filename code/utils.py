...
def get_embedding_matrix (key, tokenizer, experiment, dataset, embedding_dim = 300, force = False, lang = 'es'):
    ...
    num_lines = sum (1 for line in open (config.pretrained_models[lang][key]['vectors']))
    ...
    # Open vector file
    index = 0
    with open (config.pretrained_models[lang][key]['vectors'], 'r', encoding = 'utf8', errors = 'ignore') as f:
